...
public class AlgorithmsTheme1Prob1 {
   ...
   // ------------------------------------------------------------
   // Structure du résultat de Dijkstra
   // ------------------------------------------------------------
   ...
   // ------------------------------------------------------------
   // HYPOTHÈSE 1 : Dijkstra (plus court chemin)
   // ------------------------------------------------------------
   ...
   // ------------------------------------------------------------
   // Reconstruire la liste des sommets du chemin
   // ------------------------------------------------------------
   ...
   // ------------------------------------------------------------
   // Reconstruire les arêtes du chemin (pour les noms de rues)
   // ------------------------------------------------------------
   ...
   // ------------------------------------------------------------
   // Calculer distance entre deux points (utilisé pour NN)
   // ------------------------------------------------------------
   public static double distanceBetween(Graph g, int a, int b) {
       PathResult pr = dijkstra(g, a);
       return pr.dist[b];
   }


   // ------------------------------------------------------------
   // HYPOTHÈSE 2 : Plus proche voisin (TSP simplifié)
   // ------------------------------------------------------------
   public static List<Integer> nearestNeighbor(Graph g, int start, List<Integer> houses) {


       List<Integer> tour = new ArrayList<>();
       Set<Integer> unvisited = new HashSet<>(houses);
       ...
       while (!unvisited.isEmpty()) {
           ...
           for (int h : unvisited) {
               double d = distanceBetween(g, current, h);
               if (d < bestDist) {
                   bestDist = d;
                   bestNext = h;
               }
